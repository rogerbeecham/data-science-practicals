...
[NOTE]
====
The full practical can be viewed from this https://github.com/rogerbeecham/data-science-practicals/blob/master/07-gwss_intro.Rmd[page].
====
...
[NOTE]
====
The full practical can be viewed from this https://github.com/rogerbeecham/data-science-practicals/blob/master/08-brexit_analysis.Rmd[page].
====
